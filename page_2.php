	...
	<div class="container">
		...
		<div class="container-fluid">
			...
			<div class="navbar-collapse collapse navbar-responsive-collapse">
				<ul class="nav navbar-nav">
					<h3><li><a class="navbar-brand" href="javascript:void(0)"><b><i class="material-icons md-48"><i class="material-icons">account_circle</i></i><?php echo "Team: ".$team_name."                         Level: 2            Attempt Left: ".(7-$attempt)?></a>
				</ul>
			</div>
			</center>
        </div>
	  ...
	  <div class="bs-docs-section">
		<div class="row">
		  ...
		  <div class="col-md-6">
			<form action="php/code_check_2.php" method="POST">
